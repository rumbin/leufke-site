...
BLOG_AUTHOR = "Fam. Leufke"  # (translatable)
BLOG_TITLE = "Haus Leufke & Haus Salzhaff"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (https/https)!
...
BLOG_EMAIL = "webmaster@leufke.de"
BLOG_DESCRIPTION = {
	DEFAULT_LANG: "Ferienwohnungen im Hochschwarzwald und an der Ostseeküste",
	'en': "Holiday Apartments in the Upper Black Forest and at the Baltic Sea"
	}
# (translatable)
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ((('/schwarzwald/haus_leufke/', 'Haus Leufke im Hochschwarzwald'),
        ('/schwarzwald/wutach/', 'Appartement "Wutach"'),
		('/schwarzwald/feldberg/', 'Appartement "Feldberg"'),
		('/schwarzwald/roodbach/', 'Appartement "Roodbach"'),
		('/schwarzwald/anreise/', 'Anreise'),
		('/galleries/schwarzwald/', 'Schwarzwald-Impressionen'),
		), 'Hochschwarzwald'),
        ((('/ostsee/haus_salzhaff/', 'Haus Salzhaff an der Ostsee'),
		('/ostsee/anreise/', 'Anreise'),
		('/galleries/ostsee/', 'Ostsee-Impressionen'),
		), 'Ostsee'),
        ('/buchungsanfrage/', 'Buchungsanfrage'),
		),
    'en': (
        ((('/en/schwarzwald/haus_leufke/', 'About "Haus Leufke"'),
        ('/en/schwarzwald/wutach/', 'Holiday flat "Wutach"'),
		('/en/schwarzwald/feldberg/', 'Holiday flat "Feldberg"'),
		('/en/schwarzwald/roodbach/', 'Holiday flat "Roodbach"'),
		('/en/schwarzwald/anreise/', 'Directions'),
		('/en/galleries/schwarzwald/', 'Black Forest Impressions'),
		), 'Black Forest'),
        ((('/en/ostsee/haus_salzhaff/', 'About "Haus Salzhaff"'),
		('/en/ostsee/anreise/', 'Directions'),
		('/en/galleries/ostsee/', 'Baltic Sea Impressions'),
		), 'Baltic Sea'),
        ('/en/buchungsanfrage/', 'Booking request'),
    )
}
...
#THEME = "bootblog4"
THEME = "sandstone_local_google_fonts" # sandstone, customized to ues local google fonts
#THEME = "sandstone" # sandstone, superhero
# installed via: nikola bootswatch_theme -s sandstone
# or "flatly" instead of "sandstone"

# Primary color of your theme. This will be used to customize your theme and
# auto-generate related colors. Must be a HEX value.
THEME_COLOR = '#5670d4'
...
# Tag cloud generation is now a separate plugin (nikola plugin -i tagcloud)
# WRITE_TAG_CLOUD = True

# Categories replace sections in v8. Use CATEGORY_DESTPATH_AS_DEFAULT
# to get path-based categories (similar to old sections behavior).
...
# POSTS_SECTIONS_ARE_INDEXES = True  # Removed in v8 (sections replaced by categories)

# POSTS_SECTION_COLORS, POSTS_SECTION_DESCRIPTIONS, POSTS_SECTION_NAME,
# POSTS_SECTION_TITLE are removed in v8 (sections replaced by categories).
# Use CATEGORY_DESTPATH_NAMES for category names, and colorize_str() for colors.
# }
...
# TAG_DESCRIPTIONS (renamed from TAG_PAGES_DESCRIPTIONS in v8)
# TAG_DESCRIPTIONS = {
#    DEFAULT_LANG: {
...
# TAG_TITLES (renamed from TAG_PAGES_TITLES in v8)
# TAG_TITLES = {
#    DEFAULT_LANG: {
...
# CATEGORY_INDEXES (renamed from CATEGORY_PAGES_ARE_INDEXES in v8)
# CATEGORY_INDEXES = False

# Set descriptions for category pages to make them more interesting. The
# default is no description. The value is used in the meta description
# and displayed underneath the category list or index page’s title.
# CATEGORY_DESCRIPTIONS (renamed from CATEGORY_PAGES_DESCRIPTIONS in v8)
...
# CATEGORY_TITLES (renamed from CATEGORY_PAGES_TITLES in v8)
# CATEGORY_TITLES = {
#    DEFAULT_LANG: {
#        "blogging": "Meta-posts about blogging",
#        "open source": "Posts about open source software"
...
REDIRECTIONS = [('schwarzwald/index.html', '/schwarzwald/haus_leufke/'),
                ('ostsee/index.html', '/ostsee/haus_salzhaff/')
               ]
...
CONTENT_FOOTER = {
	DEFAULT_LANG: '&copy; {date} <a href="mailto:{email}">{author}</a> · <a href="/kontakt" rel="nofollow">Impressum</a> · <a href="/nutzungsbedingungen" rel="nofollow">Nutzungsbedingungen</a> · Erstellt mit <a href="https://getnikola.com" rel="nofollow">Nikola</a>         {license}',
	'en': '&copy; {date} <a href="mailto:{email}">{author}</a> · <a href="/en/kontakt" rel="nofollow">Imprint</a> · <a href="/en/nutzungsbedingungen" rel="nofollow">Terms of Use</a> · Powered by <a href="https://getnikola.com" rel="nofollow">Nikola</a>         {license}'
	}
...
##  placeholder="Durchsuchen&hellip;" class="span2" style="margin-top: 8px;">
...
## <input type="hidden" name="kt" value="h">
## <input type="text" name="q" maxlength="255"
##  placeholder="Search&hellip;" class="span2" style="margin-top: 8px;">
## <input type="submit" value="DuckDuckGo Search" style="visibility: hidden;">
## </form>
## <!-- End of custom search -->
## """ % SITE_URL}
...
# (translatable)
BODY_END = """
<!-- Bootstrap carousel (for autostart to work properly) -->
...
##       window.cookieconsent_options = {"message":"This website and embedded content from external services may make use of cookies. Using this website means you're OK with this.  ","dismiss":"Got it!","learnMore":"More info","link":"/en/nutzungsbedingungen","theme":"dark-bottom"};
##    } else {
##       window.cookieconsent_options = {"message":"Auf dieser Webseite und darauf eingebetteten Inhalten kommen Cookies zum Einsatz. Wenn Sie diese Webseite weiter erkunden, erklären Sie sich hiermit einverstanden.","dismiss":"OK","learnMore":"Mehr Informationen","link":"/nutzungsbedingungen","theme":"dark-bottom"};
##    }
##});
##</script>
