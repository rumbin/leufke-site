.. title: Haus Salzhaff at the Baltic Sea
.. slug: haus_salzhaff
.. date: 2016-03-12 21:52:51 UTC+01:00
.. tags: baltic_sea
.. category: baltic_sea
.. link: 
.. description: comfortable holiday home at the Baltic Sea
.. type: text
...
:In general: telephone, internet access via WiFi, central heating, iron, vacuum cleaner, 
		rotary clothes line, separate entrance, vestibule
:Living room: SAT-TV, LCD flat screen, CD player, sofa (can also be used as sofa double bed), dining area with a comfortable corner bench and a big wooden table, radio,  
		writing desk with a lamp, chest of drawers, wardrobes	
:Bedroom #1: 1 double-bed, chest of drawers, wardrobe, big window with flyscreen
:Bedroom #2: 2 single beds and space for a childbed, 2 chest of drawers, a wardrobe, big window	with flyscreen
:Kitchen: exhaust hood, freezing compartment, stove, coffee machine, fridge, 8 sets of dishes, blender, toaster, oven, microwave , dish washer,  electric kettle, ceramic glass cook top
:Bathroom: shower,  wash bassin, hair dryer, WC, towels
:Toilette: WC, wash bassin, washing machine
:Terrace: table, 2 sunbeds, 6 chairs, barbeque, and there is a nice playground next to our house
:Garden: lawn, surrounded by a fence
...
Here you have an overview about booked and free times
Just ask us and we will be glad to help you: :doc:`buchungsanfrage`
...
.. class:: text-muted
	...
	Note: The dates in the table below are formatted in ``day.month.year`` sequence.
...
.. raw:: html
	...
	<table class="data-table">
		<tr>
			<th class="border-top border-bottom border-left border-right">Period</th>
			<th class="border-top border-bottom border-right align-right">2 People</th>
			<th class="border-top border-bottom border-right align-right">3rd Adult.16+ yrs.</th>
			<th class="border-top border-bottom border-right align-right">Child 1+/6+ yrs.</th>
		</tr>
		<tr>
...
* Cleaning fee (final cleaning): 80.- €
* Dog fee (per dog per stay): 20.- €
* Dog fee (per dog per day): 5.- €

.. _gallery: /en/galleries/ostsee
